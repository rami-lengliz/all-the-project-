...
export class DemoSeedService {
  ...
  private async seedUsers() {
    ...
    const specs = [
      ...
      },
      {
        id: DEMO_IDS.HOST_B,
        name: 'Sami Trabelsi',
        email: 'host.tunis@rentai.tn',
        phone: '+21699000003',
        isHost: true,
        roles: ['user'],
      },
      {
        id: DEMO_IDS.RENTER_A,
        name: 'Fadi Hamdi',
        email: 'renter.a@rentai.tn',
        phone: '+21699000004',
        isHost: false,
        roles: ['user'],
      },
      {
        id: DEMO_IDS.RENTER_B,
        name: 'Amine Khalil',
        email: 'renter.b@rentai.tn',
        phone: '+21699000005',
        isHost: false,
        roles: ['user'],
      },
    ...
    const extraHosts = ['Yassine Mrad', 'Haythem Zghal', 'Bassem Riahi'].map(
      (name, i) => ({
    ...
    const extraRenters = ['Wissem Nasr', 'Aymen Dali', 'Rania Ben Salah'].map(
      (name, i) => ({
        id: crypto.randomUUID(),
        name,
  ...
  private async seedKelibiaListings(
    ...
    const accommodations = [
      {
        title: 'Villa Bord de Mer — Kelibia',
        price: 250,
        desc: 'Superbe villa avec vue panoramique sur la mer, piscine privée, parking, 4 chambres. Idéale pour famille ou groupe.',
      },
      {
        title: 'Appartement Vue Mer — Centre Kelibia',
        price: 120,
        desc: 'Appartement moderne au cœur de Kelibia, terrasse avec vue mer, climatisation, Wi-Fi fibre.',
      },
      {
        title: 'Maison Traditionnelle Kélibia',
        price: 90,
        desc: 'Belle maison traditionnelle renovée, court de tennis privatif, jardin avec figuiers, 3 chambres.',
      },
      {
        title: 'Studio Cosy — Plage Mansoura',
        price: 60,
        desc: 'Studio entièrement équipé à 50m de la plage Mansoura. Parfait pour couple ou solo.',
      },
      {
        title: 'Villa avec Piscine — Route de la Plage',
        price: 320,
        desc: 'Villa luxueuse, piscine chauffée, barbecue, salle de sport intégrée, 5 chambres, 3 salles de bain.',
      },
      {
        title: 'Duplex Familial — Kelibia Nord',
        price: 150,
        desc: 'Grand duplex sur 2 niveaux, 4 chambres, grande terrasse, parking sécurisé, à 300m de la mer.',
      },
      {
        title: 'Chalet en Bois — Camping Kelibia',
        price: 45,
        desc: 'Chalet écologique en bois, cuisine équipée, terrasse privée, dans un cadre naturel magnifique.',
      },
      {
        title: 'Appartement T3 — Résidence Les Pins',
        price: 110,
        desc: 'T3 moderne dans résidence sécurisée, piscine commune, parking, ascenseur, 2 chambres climatisées.',
      },
      {
        title: 'Riad Andalou — Vieille Ville',
        price: 180,
        desc: 'Riad authentique avec patio intérieur, fontaine, décoration traditionnelle. 3 chambres, ambiance unique.',
      },
      {
        title: 'Penthouse Panoramique — Cap Bon',
        price: 400,
        desc: 'Penthouse au dernier étage, terrasse 360°, vue sur le cap, 3 chambres, Jacuzzi extérieur.',
      },
    ];
    ...
    const beach = [
      {
        title: 'Location Paddle Board — Plage Mansoura',
        price: 35,
        desc: 'Stand-up paddle board de qualité pro, combinaison fournie, gilet de sécurité inclus. Durée: 2h.',
      },
      {
        title: 'Cours Jet Ski — Kelibia Beach',
        price: 80,
        desc: 'Session jet ski encadrée par instructeur certifié. 1h sur la mer, matériel fourni.',
      },
      {
        title: 'Kayak Double — Cap Bon Aventure',
        price: 25,
        desc: 'Kayak 2 places avec équipement complet. Exploration des grottes côtières du Cap Bon.',
      },
      {
        title: 'Masques & Tubas — Pack Snorkeling',
        price: 15,
        desc: 'Pack complet snorkeling pour 2 personnes. Eaux cristallines garanties dans les spots de Kelibia.',
      },
      {
        title: 'Bateau Pneumatique — Pêche & Détente',
        price: 60,
        desc: 'Bateau gonflable motorisé pour 4 personnes. Parfait pour la pêche ou la balade côtière.',
      },
      {
        title: 'Catamaran — Demi-journée Kelibia',
        price: 120,
        desc: 'Catamaran 6 personnes, équipement snorkeling inclus, guide à bord, déjeuner à bord offert.',
      },
      {
        title: 'Surf & Wake — Location Matériel',
        price: 40,
        desc: 'Wakeboard, combinaison néoprène, casque. Spot de wake à 5 min du port de Kelibia.',
      },
      {
        title: 'Chaises & Parasols — Plage VIP',
        price: 20,
        desc: 'Installation VIP sur plage privée: 2 chaises longues + parasol + service boissons.',
      },
    ];
  ...
  private async seedTunisListings(
    users: Record<string, any>,
    cats: Record<string, any>,
  ) {
    const hostA = users['host.kelibia@rentai.tn'];
    ...
    const accommodations = [
      {
        title: 'Appartement Moderne — Les Berges du Lac',
        price: 140,
        desc: 'Appartement haut standing, vue lac, salle de sport, parking, 24h/24 sécurité. 2 chambres.',
      },
      {
        title: 'Studio Meublé — Centre Tunis',
        price: 70,
        desc: 'Studio entièrement meublé en centre-ville, proche métro, cuisine équipée, Wi-Fi inclus.',
      },
      {
        title: 'Villa La Marsa — Banlieue Nord',
        price: 380,
        desc: 'Grande villa à La Marsa, jardin 500m², piscine, 5 chambres, personnel de maison inclus.',
      },
      {
        title: 'Appartement T2 — Menzah 6',
        price: 95,
        desc: 'Appartement T2 calme et lumineux, résidence sécurisée, parking, à 10 min du centre.',
      },
      {
        title: 'Loft Design — El Manar',
        price: 160,
        desc: 'Loft moderne design, open space, 2 chambres en mezzanine, terrasse privée, vue panoramique.',
      },
      {
        title: 'Résidence Gammarth — Vue Mer',
        price: 220,
        desc: 'Appartement en résidence de luxe à Gammarth, piscine, vue mer, 2 chambres, terrasse.',
      },
      {
        title: 'Maison Traditionnelle — Médina Tunis',
        price: 130,
        desc: 'Maison authentique en médina, patio intérieur, décoration zellige, 3 chambres, expérience unique.',
      },
      {
        title: 'Appartement Ennasr — Long séjour',
        price: 60,
        desc: 'Idéal séjour long, toutes charges comprises, cuisine équipée, lave-linge, parking gratuit.',
      },
    ];
    for (let i = 0; i < accommodations.length; i++) {
      const { title, price, desc } = accommodations[i];
  ...
  private async seedDemoScenarios(
    users: Record<string, any>,
    cats: Record<string, any>,
  ) {
    ...
    await this.insertListing({
      ...
      description:
        'Superbe villa pour démonstration du conflit de réservation (dates D+30 à D+33 bloquées). 3 chambres, piscine, vue mer.',
      price: 200,
      lat: lat + 0.05,
      lng: lng + 0.05,
    ...
    await this.insertListing({
      ...
      description:
        'Terrain de tennis pour démonstration du conflit de créneaux (10:00–12:00 sur D+7 bloqué). Surface en dur, éclairage LED.',
      price: 30,
      lat: lat + 0.06,
      lng: lng + 0.06,
    ...
    const t10 = new Date(0);
    t10.setUTCHours(10, 0, 0, 0);
    const t12 = new Date(0);
    t12.setUTCHours(12, 0, 0, 0);
    const t11 = new Date(0);
    t11.setUTCHours(11, 0, 0, 0);
    const t13 = new Date(0);
    t13.setUTCHours(13, 0, 0, 0);
  ...
  private async seedGeneralBookings(
    users: Record<string, any>,
    listings: any[],
  ) {
    const renterA = users['renter.a@rentai.tn'];
  ...
  private async seedChatMessages(
    users: Record<string, any>,
    listings: any[],
    _demo: Awaited<ReturnType<typeof this.seedDemoScenarios>>,
  ) {
    const renterA = users['renter.a@rentai.tn'];
    const renterB = users['renter.b@rentai.tn'];
    const host = users['host.kelibia@rentai.tn'];
    const _hostB = users['host.tunis@rentai.tn'];
    ...
    await this.createMessages(conv1.id, renterA.id, host.id, [
      {
        s: 'renter',
        t: 'Bonjour Mohamed ! Je suis très intéressé par votre villa pour la période du mois prochain.',
      },
      {
        s: 'host',
        t: 'Bonjour Fadi ! Bienvenue. La villa est disponible, que voulez-vous savoir ?',
      },
      { s: 'renter', t: 'Y a-t-il une piscine et le parking est-il inclus ?' },
      {
        s: 'host',
        t: 'Absolument ! Piscine privée ouverte 8h–21h, et parking couvert pour 2 voitures.',
      },
      {
        s: 'renter',
        t: 'La climatisation est-elle dans toutes les chambres ?',
      },
      {
        s: 'host',
        t: 'Oui, chaque chambre a sa propre climatisation réversible + ventilateur de plafond.',
      },
      {
        s: 'renter',
        t: 'Super. Le Wi-Fi est-il fiable ? Je dois travailler le matin.',
      },
      {
        s: 'host',
        t: 'Fibre 200 Mbps dans toute la villa, parfait pour le télétravail.',
      },
      {
        s: 'renter',
        t: 'Y a-t-il un barbecue ? Nous serons une famille de 6 personnes.',
      },
      {
        s: 'host',
        t: 'Grand barbecue gaz dans le jardin + plancha. La cuisine extérieure est complète.',
      },
      { s: 'renter', t: 'La mer est à quelle distance ?' },
      {
        s: 'host',
        t: 'À exactement 150 mètres à pied. Accès direct plage privée avec transats.',
      },
      {
        s: 'renter',
        t: "Parfait, c'est exactement ce qu'il nous faut ! Je confirme la réservation.",
      },
      {
        s: 'host',
        t: 'Excellent choix ! Virement effectué, réservation confirmée. À très bientôt !',
      },
      {
        s: 'renter',
        t: "Merci Mohamed, on a hâte d'arriver ! Nous transmettrons vos coordonnées à la famille.",
      },
    ]);
    ...
    await this.createMessages(conv2.id, renterA.id, host.id, [
      {
        s: 'renter',
        t: 'Bonjour, je voudrais réserver le terrain de tennis pour 10h–12h.',
      },
      { s: 'host', t: 'Bonjour Fadi ! Le créneau est libre. Confirmé ?' },
      {
        s: 'renter',
        t: 'Oui ! Nous serons 2 joueurs. Les raquettes sont-elles disponibles ?',
      },
      {
        s: 'host',
        t: 'Raquettes, balles et eau fraîche incluses dans le tarif.',
      },
      { s: 'renter', t: 'Y a-t-il des vestiaires avec douches ?' },
      {
        s: 'host',
        t: 'Oui, vestiaires mixtes avec douches chaudes et casiers sécurisés.',
      },
      { s: 'renter', t: "Super. Est-ce qu'il y a du parking sur place ?" },
      {
        s: 'host',
        t: 'Parking gratuit pour 20 voitures directement sur le complexe.',
      },
      {
        s: 'renter',
        t: 'Parfait ! Réservation confirmée pour 10h–12h. À demain !',
      },
      { s: 'host', t: 'À demain Fadi ! Bonne partie de tennis 🎾' },
    ]);

    // ── Conv 3: Beach activity — renterB ↔ hostB (8 messages) ───────────────
    const beachListing = listings.find((l) =>
      l.title?.includes('Paddle Board'),
    );
    if (beachListing) {
      ...
      await this.createMessages(conv3.id, renterB.id, beachListing.hostId, [
        {
          s: 'renter',
          t: "Bonjour, est-ce que l'activité paddle board est adaptée pour débutants ?",
        },
        {
          s: 'host',
          t: "Bonjour Amine ! Oui, niveau débutant suffit. Cours d'initiation de 20 min offert.",
        },
        {
          s: 'renter',
          t: 'Nous sommes 2 personnes. Les gilets de sécurité sont inclus ?',
        },
        {
          s: 'host',
          t: 'Gilets, casques et crème solaire fournis. Votre sécurité est notre priorité.',
        },
        { s: 'renter', t: "Quelle est la durée exacte de l'activité ?" },
        {
          s: 'host',
          t: "2h sur l'eau + 20 min briefing = session complète de 2h20.",
        },
        { s: 'renter', t: 'On réserve pour samedi matin ! ' },
        {
          s: 'host',
          t: 'Réservé ! Rendez-vous samedi à 9h à la plage Mansoura. Belle journée mer 🌊',
        },
      ]);
    }
    ...
    if (mobilityListing) {
      ...
      await this.createMessages(conv4.id, renterA.id, mobilityListing.hostId, [
        {
          s: 'renter',
          t: 'Bonjour, le scooter 125cc est-il disponible pour ce week-end ?',
        },
        {
          s: 'host',
          t: 'Bonjour ! Week-end libre. Kilométrage illimité, plein offert au départ.',
        },
        { s: 'renter', t: 'Quel est le montant du dépôt de garantie ?' },
        {
          s: 'host',
          t: '300 TND de caution, remboursée intégralement à la restitution, sous 2h.',
        },
        { s: 'renter', t: 'Le casque intégral est-il fourni ?' },
        {
          s: 'host',
          t: "Casque intégral + veste anti-vent fournis. Taille disponible jusqu'au XL.",
        },
        { s: 'renter', t: 'Y a-t-il une assurance incluse ?' },
        {
          s: 'host',
          t: 'Assurance tous risques + assistance 24h/7j incluse dans le tarif.',
        },
        {
          s: 'renter',
          t: 'Parfait ! Je confirme la réservation pour ce weekend. Merci Sami !',
        },
      ]);
    }
    ...
    if (tunisAccom) {
      const conv5 = await this.prisma.conversation.create({
        data: {
          renterId: renterB.id,
          hostId: tunisAccom.hostId,
          listingId: tunisAccom.id,
        },
      });
      await this.createMessages(conv5.id, renterB.id, tunisAccom.hostId, [
        {
          s: 'renter',
          t: "Bonjour, l'appartement des Berges du Lac est-il disponible pour 5 nuits ?",
        },
        {
          s: 'host',
          t: 'Bonjour Amine ! Disponible. Quelles sont vos dates exactes ?',
        },
        {
          s: 'renter',
          t: 'Du 15 au 20 mars. Est-ce que la vue lac est garantie ?',
        },
        {
          s: 'host',
          t: 'Vue panoramique sur le lac depuis le salon et la chambre principale. Garantie.',
        },
        { s: 'renter', t: 'Y a-t-il une salle de sport dans la résidence ?' },
        {
          s: 'host',
          t: 'Salle de sport complète ouverte 6h–23h, accès gratuit pour nos locataires.',
        },
        {
          s: 'renter',
          t: 'Réservation confirmée ! Merci pour les informations détaillées.',
        },
      ]);
    }
  ...
  private async seedReviews(users: Record<string, any>) {
    const _renterA = users['renter.a@rentai.tn'];
    const _host = users['host.kelibia@rentai.tn'];
  ...
  private async createMessages(
    ...
    for (let i = 0; i < msgs.length; i++) {
      ...
      createdAt.setMinutes(
        createdAt.getMinutes() - (msgs.length - i) * minutesApart,
      );
  ...
  private printAndSaveSummary(demo: {
    ...
    console.log(
      '  ║           ✅  DEMO SEED COMPLETE — Copy for demo/tests          ║',
    );
    console.log(
      '  ╠══════════════════════════════════════════════════════════════════╣',
    );
    ...
    console.log(
      `  ║  Blocked dates  : ${fmt(demo.dailyStart)} → ${fmt(demo.dailyEnd)} (confirmed+paid)          ║`,
    );
    console.log(`  ║  SLOT  listing  : ${demo.slotListingId}  ║`);
    console.log(
      `  ║  Blocked slot   : 10:00–12:00 on ${fmt(demo.slotDate)} (confirmed+paid)    ║`,
    );
    console.log(
      '  ╠══════════════════════════════════════════════════════════════════╣',
    );
    console.log(
      `  ║  Admin login    : admin@rentai.tn / password123                 ║`,
    );
    console.log(`  ║  Host login     : ${demo.hostEmail} / password123   ║`);
    console.log(
      `  ║  RenterA login  : ${demo.renterAEmail} / password123     ║`,
    );
    console.log(
      `  ║  RenterB login  : ${demo.renterBEmail} / password123     ║`,
    );
    console.log(
      '  ╚══════════════════════════════════════════════════════════════════╝',
    );
